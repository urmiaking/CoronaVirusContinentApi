...
namespace CoronaVirusContinentApi.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ContinentsController : ControllerBase
    {
        private readonly CoronaVirusContinentApiContext _context;

        public ContinentsController(CoronaVirusContinentApiContext context)
        {
            _context = context;
        }
        ...
        {
            var continent = await _context.Continent.FirstOrDefaultAsync(a => a.Name.Equals(name));
